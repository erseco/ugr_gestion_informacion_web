...
\newcommand{\titulo}{Análisis Preliminar y Visualización Básica de una Red Social con Gephi}
...
\newcommand{\profesor}{Oscar Cordón García}
...
\providecommand{\keywords}{gephi, análisis, evaluuación, redes, miserables}
