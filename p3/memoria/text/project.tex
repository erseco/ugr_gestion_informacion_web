...
\newcommand{\titulo}{Desarrollo de un Sistema de Recuperación de Información con Lucene}
...
\providecommand{\keywords}{software libre, recuperación información, lucene}
